...
export const QUAD_FEEDS: FeedConfig[] = [
  {
    ...
    liveUrl: 'https://www.youtube.com/embed/EEapxjooQT8?rel=0',
    fallbackVideoId: 'D0H7_bY9XgU',
  ...
  },
  {
    ...
    liveUrl: 'https://www.youtube.com/embed/s9P1Lp5-8eE?rel=0',
    fallbackVideoId: 'Hu8D2snYlJY',
